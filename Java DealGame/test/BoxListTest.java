...
public class BoxListTest extends TestCase {
    ...
    private double[] monetaryAmounts2 =  {10.0, 50.0, 100.0, 250.0};
    ...
    public void testGetValue2() {
        assertEquals("Get Value ", 10.0, boxList2.getValue(0), DELTA);
        assertEquals("Get Value ", 50.0, boxList2.getValue(1), DELTA);
        assertEquals("Get Value ", 100.0, boxList2.getValue(2), DELTA);
        assertEquals("Get Value ", 250.0, boxList2.getValue(3), DELTA);
    }
    ...
    // TODO: Test isOpen for added BoxList. Test should be in its own method.
    ...
    public void testOpen2() {
        boxList2.open(0);
        boxList2.open(2);
        assertTrue("Open", boxList2.isOpen(0));
        assertFalse("Open", boxList2.isOpen(1));
        assertTrue("Open", boxList2.isOpen(2));
        assertFalse("Open", boxList2.isOpen(3));
    }
    // TODO: Test open for added BoxList. Test should be in its own method.
    ...
    public void testAverageValueOfUnopenedBoxes2() {
        assertEquals("Average Value Of Unopened Boxes", 102.5, 
                     boxList2.averageValueOfUnopenedBoxes(), DELTA);
        boxList2.open(0);
        boxList2.open(2);
        assertEquals("Average Value Of Unopened Boxes", 150.0, 
                     boxList2.averageValueOfUnopenedBoxes(), DELTA);
        boxList2.open(1);
        boxList2.open(3);
        assertEquals("Average Value Of Unopened Boxes", 0, 
   ...
   @Test
    ...
    public void testEquals2() {
        ...
        double[] differentAmounts = {1.0, 1.9, 3.6, 7.5};
        assertFalse("boxList1 with different values", 
                    boxList2.equals(new BoxList(differentAmounts)));
        double[] differentLength = {10.0, 50.0, 100.0};
        ...
        assertFalse("boxList2 compared to String", boxList2.equals("box list 2"));
    }
    // TODO: Test equals for added BoxList. Test should be in its own method.
    ...
    public void testToString2() {
        String expected = "0: Open: false Value: 10.0\n" +
                          "1: Open: false Value: 50.0\n" +
                          "2: Open: false Value: 100.0\n" +
                          "3: Open: false Value: 250.0\n";
        assertEquals("toString  after constructed", expected, boxList2.toString());
        boxList2.open(1);
        boxList2.open(2);
        expected = "0: Open: false Value: 10.0\n" +
                   "1: Open: true Value: 50.0\n" +
                   "2: Open: true Value: 100.0\n" +
                   "3: Open: false Value: 250.0\n";
        assertEquals("toString  after opening two boxes", expected, boxList2.toString());
    }
    // TODO: Test toString for added BoxList. Test should be in its own method.
}
