...
public class BoxTest extends TestCase {
    ...
    public void testGetValueBox2() {
        assertEquals("box2 value", 14.20, box2.getValue(), DELTA);
    ...
    // TODO: Test open for added Box. Test should be in its own method
    ...
    public void testEqualsBox2() {
        ...
        assertTrue("box2 equals with different instances", box2.equals(new Box(14.20)));
        assertTrue("box2 with similar value", box2.equals(new Box(14.209)));
        assertFalse("box2 with somewhat different value", box2.equals(new Box(14.77)));
        Box openBox = new Box(14.20);
        openBox.open();
        assertFalse("box2 with same value but open", box2.equals(openBox));
        Box openDifferentValueBox = new Box(54.6);
        openDifferentValueBox.open();
    ...
    // TODO: Test equals for added Box. Test should be in its own method.
    ...
    public void testToStringBox2() {
        assertEquals("box2 toString", "Open: false Value: 14.2", box2.toString());
    }
    
    // TODO: Test toString for added Box. Test should be in its own method.
