...
@Test
    public void testGetBoxesRemainingToOpenSecondRound() {
        game.startNextRound();
        String id = "five boxes to open in the second round";
    ...
    @Test
    public void testGetBoxesOpenedThisRound2() {
        
        game.selectBox(12);
        game.hasPlayerChosenBox();
        game.selectBox(11);
        String id = "1 Box open at the start of the first round";
        int exp = 1;
        int act = game.getBoxesOpenedThisRound();
        assertEquals(id, exp, act);
    ...
    public void testGetPlayerBoxValue() {
        ...
        @Test
    public void testGetPlayerBoxValue2() {
        game.selectBox(2);
        String id = "Player box value before selecting box";
        double exp = 5;
        double act = game.getPlayerBoxValue();
    ...
    public void testIsBoxOpen2() {
        ...
        String id = "One Box Selected: ";
        String desc = "game.isBoxOpen ";
        assertTrue(id + desc, game.isBoxOpen(1));
    }
    ...
    public void testGetCurrentOffer() {
        ...
        @Test
    public void testGetCurrentOffer2() {
        game.selectBox(24);
        game.hasPlayerChosenBox();
        game.selectBox(0);
        String id = " After First Box is picked";
        double exp = 13673.66;
        double act = game.getCurrentOffer();
        assertEquals(id, exp, act, DELTA);
    ...
    public void testGetHighScore() {
        ...
        @Test
    public void testGetHighScore2() {
        String id = " New high score";
        assertTrue(id, game.isNewHighScore(200.0));
    ...
    public void testGetValueInBox() {
        ...
        @Test
    public void testGetValueInBox2() {
        String id = "Value in box 3";
        double exp = 10;
        double act = game.getValueInBox(3);
        assertEquals(id, exp, act, DELTA);
    }
    ...
    public void testIsNewHighScore2() {
        String id = "New high score 2";

        // Test that the new score was recorded
        assertTrue(id, game.isNewHighScore(1000.0));
        double exp = 1000.0;
        double act = game.getHighScore();
        assertEquals(id, exp, act, DELTA);
        ...
        @Test
    public void testIsNewHighScore3() {
        // Start with no high score - do before starting game
        String id = "New high score";

        // Test that the new score was recorded
        assertFalse(id, game.isNewHighScore(8.0));
        double exp = game.getHighScore();
        double act = game.getHighScore();
        assertEquals(id, exp, act, DELTA);
